...
class GresColabController extends Controller
{
    /**
     * Obtiene todos los colaboradores de un buque.
     */
    ...
    {
        $colaborador = GresColab::where('buque_id', $buqueId)
            ->where('id', $id)
            ->first();
    ...
    public function store(Request $request)
    {
        ...
        $colaborador = GresColab::create($request->all());
